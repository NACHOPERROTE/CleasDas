const Productos = (props) =>{
    ...
    const contenedorProductosUno = document.querySelector('#contenedorProductosLavandina')
...
let catalogo = [
    ...
    let lavandinas = catalogo.filter( (prod) => prod.tipo === 'lavandina' )
    ...
    div.classList.add('section__colProductos')
    div.innerHTML = `
    <h3 className="section__colProductos--h3">${producto.nombre}</h3>
    <p className="section__colProductos--p">$${producto.precio}</p>
    <div className="boton-agregar"><button id="agregar${producto.id}" className="boton-estilo">Agregar</button></div>
    `
